...
(function( $ ) {
    ...
    $.fn.thooClock = function(options) {
        ...
        this.each(function() {
            ...
            el.borderColor = settings.borderColor;
            el.borderWidth = settings.borderWidth;
            ...
            function startClock(x){
                ...
                if (options.offset !== undefined && options.offset !==null && options.offset !== 0) {
                    if (options.unit === "年") {
                        theDate.setFullYear(theDate.getFullYear() + options.offset );
                    } else if (options.unit === "月") {
                        theDate.setMonth(theDate.getMonth() + options.offset );
                    } else if (options.unit === "日") {
                        theDate.setDate(theDate.getDate() + options.offset );
                    } else if (options.unit === "时") {
                        theDate.setHours(theDate.getHours() + options.offset );
                    } else if (options.unit === "分") {
                        theDate.setMinutes(theDate.getMinutes() + options.offset );
                    } else if (options.unit === "秒") {
                        theDate.setSeconds(theDate.getSeconds() + options.offset );
                    }
                }
                ...
                let lineWidth =   el.borderWidth  ;
                // 绘制空心圆
                ctx.beginPath();
                ctx.arc(0, 0, (el.size/2) - lineWidth/1.8, 0, 2 * Math.PI);
                ctx.lineWidth = lineWidth;
                ctx.strokeStyle =  el.borderColor; // 线条颜色
                ctx.stroke();
